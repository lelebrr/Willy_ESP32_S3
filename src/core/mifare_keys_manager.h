...
public:
  ...
  static void ensureLoaded(std::set<String> &keys, bool allowSD = true);
...
private:
  // File I/O
  static void loadFromFile(std::set<String> &keys, bool allowSD = true);
  ...
  // Filesystem helpers
  static bool writeToFS(FS *fs, const char *fsName,
