...
void Wigle::send_upload_headers(WiFiClientSecure &client, String filename,
                                int filesize, String boundary) {
  // Content-Disposition header size.
  int cd_header_len =
      147 - 45 - 8 + filename.length() + 2 * (boundary.length() + 2);
