...
| ------------ | --------------- | ----------- |
| **ESP32-S3-DevKitC-1-N8R2** | Dual-Core 240MHz, 8MB Flash | CPU principal com 320KB RAM e 2MB PSRAM (QSPI) |
...
| ------------ | --------------- | -------- |
| **ESP32-S3-DevKitC-1-N8R2** | Dual-Core 240MHz, 8MB Flash, 2MB PSRAM QSPI | ⭐ Principal |
...
| ------------ | ---------------- | -------- |
| **Display TFT ILI9341** | VCC:3.3V, GND:GND, CS:10, DC:9, RST:14, MOSI:11, SCLK:12, MISO:13, LED/BL:3 | SPI Display + Backlight |
| **Touch XPT2046** | CS:15, IRQ:-1 (Não usado) | SPI Touch |
